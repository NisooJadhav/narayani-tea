export const site = {
  ...
  url: "https://www.narayanitea.com",
  email: "narayanitea@gmail.com",
  description:
    "Premium tea powder, jaggery tea premixes, family blends, and health-first beverage products from Narayani Tea.",
  nav: [
    { href: "/", label: "Home" },
...
export const brochureNotes = [
  "Tea powder manufacturer and seller",
  "Kadak Dust, Family Blend, Coffee Jaggery Premix, Ginger and Elaichi Tea",
  "Website: www.narayanitea.com",
  "Email: narayanitea@gmail.com"
];
